package com.pcitc.shiro_demo.realm;
...
import com.pcitc.shiro_demo.mapper.UUserDao;
...
public class ShiroRealm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authenticationToken) throws AuthenticationException {
        ...
        if (hasUser != null) {
            ...
            List<UPermission> plist = uPermissionService.findPermissionByUid(hasUser.getId());//获取用户权限
